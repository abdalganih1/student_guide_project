...
<div class="container-fluid">
    <h1><i class="fas fa-plus-circle me-2"></i>إضافة مقرر جديد</h1>
            ...
            <form action="{{ route('admin.courses.store') }}" method="POST">
                ...
                <div class="row">
                    <div class="col-md-4 mb-3">
                        ...
                        <input type="text" class="form-control @error('semester_display_info') is-invalid @enderror" id="semester_display_info" name="semester_display_info" value="{{ old('semester_display_info') }}" placeholder="مثال: الخريف 2024، السنة الأولى / الفصل الأول" required>
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <input type="number" class="form-control @error('year_level') is-invalid @enderror" id="year_level" name="year_level" value="{{ old('year_level') }}" min="1">
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <input type="number" class="form-control @error('credits') is-invalid @enderror" id="credits" name="credits" value="{{ old('credits') }}" min="0">
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <select class="form-select @error('is_enrollable') is-invalid @enderror" id="is_enrollable" name="is_enrollable" required>
                            <option value="1" {{ old('is_enrollable', '1') == '1' ? 'selected' : '' }}>نعم، متاح للتسجيل</option>
                            <option value="0" {{ old('is_enrollable') == '0' ? 'selected' : '' }}>لا، غير متاح للتسجيل</option>
                        </select>
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="number" class="form-control @error('enrollment_capacity') is-invalid @enderror" id="enrollment_capacity" name="enrollment_capacity" value="{{ old('enrollment_capacity') }}" min="0">
                        @error('enrollment_capacity') <div class="invalid-feedback">{{ $message }}</div> @enderror
                    </div>
                </div>

                <div class="mt-4">
                    <button type="submit" class="btn btn-primary"><i class="fas fa-save me-1"></i> حفظ المقرر</button>
