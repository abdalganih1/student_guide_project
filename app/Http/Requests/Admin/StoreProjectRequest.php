...
class StoreProjectRequest extends FormRequest
{
    ...
    {
        return [
            // تم تغيير specialization_id إلى specialization_ids (مصفوفة)
            'specialization_ids' => 'required|array', // مطلوب كمصفوفة
            'specialization_ids.*' => 'exists:specializations,id', // كل عنصر في المصفوفة يجب أن يكون موجوداً في جدول الاختصاصات
            // تم إزالة قاعدة التحقق من specialization_id إذا كان لا يشير للتخصص الرئيسي الإلزامي
